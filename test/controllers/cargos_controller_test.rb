...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { borrado: @cargo.borrado, nombre: @cargo.nombre, tipo: @cargo.tipo } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { borrado: @cargo.borrado, nombre: @cargo.nombre, tipo: @cargo.tipo } }
